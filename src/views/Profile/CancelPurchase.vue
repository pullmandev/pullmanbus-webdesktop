      ...
      <v-card class="rounded-search-box">
        ...
        <v-card-text>
          <p class="subheading">
            ...
            dinero. La devolución debe ser realizada por lo menos 4 hrs. antes de la
            salida del servicio.
          </p>
          <form>
            <v-row>
          ...
          <i class="subheading" v-if="tickets.length > 0">
            *Si la compra se realizo con tarjeta de crédito, se generará una reversa en su
            cuenta, si se realizo con tarjeta de débito, se realizará una transferencia a
            la cuenta que entregue para este fin. La devolución o reversa se hara efectiva
