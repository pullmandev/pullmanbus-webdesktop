<template>
  <v-container>
    <div class="justifyText">
      ...
      <p class="subheading"><b>I.- CONDICIONES COMERCIALES Y RESTRICCIONES</b></p>
      <p>
        <ol class="ml-4">
          ...
          <li>La venta de pasajes por Internet estará disponible para todas las personas que posean tarjetas de crédito bancarias y de casas comerciales en convenio con Viaja en bus.</li>
          ...
          <li>La compra de Pasajes por Internet aceptará como medio de pago las tarjetas de crédito bancarias emitidas en Chile y se hará a través del servicio WEB PAY de Transbank S.A. que incorpora elementos de seguridad provistos por Transbank S.A. Se limita la cantidad de compras diarias con tarjetas de crédito bancarias y de casas comerciales por razones de seguridad para nuestros clientes.</li>
          <li>Las tarjetas de crédito emitidas en Chile serán cargadas en pesos conforme a lo determinado por Transbank S.A.</li>
          <li>El uso, condiciones de crédito, intereses y otras condiciones de las tarjetas de crédito bancarias aplicables son de exclusiva responsabilidad de su emisor y no de Viaja en bus.</li>
          ...
          <li>Las compras de pasajes e www.viajaenbus.cl, son válidas para la fecha y hora del servicio seleccionado por el cliente al momento de efectuar la compra; por lo tanto, no habrá canjes o cambios para las compras realizadas vía internet.</li>
        </ol>
      </p>
      <p class="subheading"><b>II.- CONDICIONES DE DEVOLUCIÓN DE COMPRAS POR INTERNET</b></p>
      <p>Viaja en bus confirmará la recepción mediante el envío de un correo electrónico. El cliente podrá nos podrá contactar mediante correo al contacto@viajaenbus.cl para confirmar dicha recepción. Los plazos de reversa de las devoluciones solicitadas a través de nuestra página web se cursarán con un plazo de:
        <ul class="ml-4">
          <li>5 días hábiles para las compras con tarjeta de débito. Viaja en bus realizará una transferencia electrónica a la cuenta corriente indicada por el cliente al momento de solicitar su devolución.</li>
      ...
      <p class="mt-2">
        ...
        <ol class="ml-4">
          <li>Para realizar el proceso de devolución, el cliente debe estar previamente registrado en sitio www.viajaenbus.cl , iniciar su sesión, e ir al Menú en opción “Devoluciones”, donde deberá ingresar el número de orden.</li>
          <li>La devolución puede ser por uno o el total de los boletos comprados en la transacción.</li>
          <li>La devolución debe ser realizada por lo menos 4 horas antes de la salida del servicio del boleto que se desea anular.</li>
      ...
      <p>
        <ol class="ml-4">
          ...
          <li>Empresas Viaja en bus no guarda registro de las tarjetas de crédito y/o Debito porque los datos de éstas son encriptados por Transbank S.A. y es esta última la que certifica la transacción.</li>
          <li>Viaja en bus en caso de necesidad, (incluyendo pero no limitado a caso fortuito o fuerza mayor), podrá cancelar el servicio, sustituyéndolo por otro similar, operado por Viaja en bus u otra empresa de buses asociada.</li>
          ...
          <li>
            Pullman Bus se reserva la facultad, de que si estima que un pasajero pudiese afectar la seguridad o transporte de los demás pasajeros, se negará a prestarle el servicio, debido a una conducta contraria al comportamiento razonable que debe mantener una persona abordo:
            <ul class="ml-4">
      ...
      <p class="subheading"><b>IV.- CONDICIONES DEL EQUIPAJE: Artículo 68 decreto supremo 212</b></p>
      ...
      <p class="subheading"><b>V.- LÍMITES DE RESPONSABILIDAD: Artículo 70 Decreto Supremo 212 MTT</b></p>
      <p>
